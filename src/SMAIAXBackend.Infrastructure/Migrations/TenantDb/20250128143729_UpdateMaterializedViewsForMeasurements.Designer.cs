...
namespace SMAIAXBackend.Infrastructure.Migrations.TenantDb
{
    ...
    [Migration("20250128143729_UpdateMaterializedViewsForMeasurements")]
    partial class UpdateMaterializedViewsForMeasurements
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SMAIAXBackend.Domain.Model.Entities.Measurement", b =>
                {
                    ...
                    b.Property<double>("NegativeReactiveEnergyTotal")
                        .HasColumnType("double precision")
                    ...
                    b.Property<double>("PositiveReactiveEnergyTotal")
                        .HasColumnType("double precision")
